 ...
 */
class ThemeSwitcherForm extends FormBase implements TrustedCallbackInterface {

  /**
   * Lazy builder callback for hook_page_bottom().
   *
   * @return array
   *   The built theme switcher form render array.
   */
  public static function lazyBuilder(): array {
    return \Drupal::formBuilder()->getForm(self::class);
  }
  ...
  /**
   * List of available themes, keyed by machine name.
   *
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['preferred_theme'] = [
      ...
      '#default_value' => ($this->currentTheme !== NULL && !empty($this->availableThemes[$this->currentTheme])) ? $this->currentTheme : NULL,
